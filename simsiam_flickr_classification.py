...
def main_worker(args):
    ...
    # init the fc layer
    model.fc.out_features = 32 # number of car logo classes.
    ...
    train_sampler = None
    train_set, _ = torch.utils.data.random_split(dataset1, [6592, 1648])
    _, test_set = torch.utils.data.random_split(dataset2, [6592, 1648])
...
def save_checkpoint(state, is_best, filename='checkpoint.pth.tar'):
    ...
    """
    filename = os.path.join("./cls_checkpointsflickr/", filename)
