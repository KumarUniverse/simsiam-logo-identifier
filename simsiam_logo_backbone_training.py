...
import simsiam.builder_backbone
...
# models: 'resnet50', 'efficientnet_v2_s', 'inception_v3'
...
def main_worker(args):
    ...
    arch_model = models.__dict__[args.arch]
    arch_model.name = args.arch
    model = simsiam.builder_backbone.SimSiam(arch_model)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if is_checkpoint_saved and ((epoch+1) % 5 == 0):
            ...
            }, is_best=False, filename='checkpoint_{}_{:04d}.pth.tar'.format(args.arch, epoch))
